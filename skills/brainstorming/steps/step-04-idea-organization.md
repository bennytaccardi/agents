...
The brainstorming session is complete when the ideas are organized, priorities are clear, and the user leaves with concrete next steps and a usable session document.
